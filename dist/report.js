 ...
 */
export function createRegistryReport(index) {
 ...
 */
export function formatRegistryReportMarkdown(report) {
    const lines = [
...
export function formatRegistryReportHtml(report) {
    const findings = report.issues.length === 0
        ? "<p>No findings.</p>"
    ...
    const skills = report.skills.length === 0
...
function formatSkillRows(reportSkills) {
